...
public class UserController {
    ...
    @Operation(
            ...
            description = "Permite al usuario subir una imagen de perfil. La imagen se guardará y se asociará al usuario.",
            security = @SecurityRequirement(name = "bearerAuth")
    )
    @ApiResponses(value = {
            @io.swagger.v3.oas.annotations.responses.ApiResponse(responseCode = "200", description = "Imagen subida exitosamente",
    ...
    public ResponseEntity<ImageResponse> uploadProfileImage(
        ...
        return new ResponseEntity<>(new ImageResponse(fileName, "Profile image uploaded successfully"), HttpStatus.OK);
    }

    @Operation(
            summary = "Obtener imagen de perfil",
            description = "Descarga la imagen de perfil de un usuario"
    )
    @ApiResponses(value = {
